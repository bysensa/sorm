...
/// # Example
/// ```
/// # use sorm_query::validators::assert_type_is_number;
...
/// Validate that type is a surrealdb sorm Object at compile time
pub trait IsObject {}

impl<T: Object> IsObject for T {}

/// Validate that type is an embedded surreal sorm Object at compile time
/// # Example
/// ```rust,ignore
