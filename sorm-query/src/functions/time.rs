...
create_time_fn_with_single_datetime_arg!(
    ...
    /// # Arguments
    ///
    /// * `datetime` - The datetime to sorm-derive nanoseconds since epoch from. Could also be a field or a parameter representing a datetime.
    ///
    /// # Example
    /// ```rust
    /// # use sorm_query as  surreal_orm;
...
create_time_fn_with_single_datetime_arg!(
    ...
    /// # Arguments
    ///
    /// * `datetime` - The datetime to sorm-derive seconds since epoch from. Could also be a field or a parameter representing a datetime.
    ///
    /// # Example
    /// ```rust
    /// # use sorm_query as  surreal_orm;
