...
#[sorm(table = planet)]
pub struct Planet<T: Clone + Serialize + sorm::validators::Int + Default> {
    pub id: SurrealSimpleId<Self>,
    pub name: String,
    // area: Polygon,
    // #[sorm(ty = "any")]
    // #[sorm(ty = "array")]
    // #[sorm(ty = "array", item_type = "int")]
    // #[sorm(ty = "array", item_type = "int")]
    // #[sorm(ty = "int")]
...
mod tests {
    use super::*;
    use sorm::{SchemaGetter, SetterArray};
...
#[serde(rename_all = "camelCase")]
#[sorm(table = planet_x)]
pub struct PlanetX<T: Clone + Serialize + sorm::validators::Int + Default> {
    pub id: SurrealSimpleId<Self>,
    pub name: String,
    pub population: u64,
    pub created: DateTime<Utc>,
