...
use sorm::{LinkMany, LinkOne, LinkSelf, Node, Relate, SurrealSimpleId};
use surrealdb::sql;
...
pub struct Alien {
    ...
    #[sorm(relate(model = "AlienVisitsPlanet", connection = "->visits->planet"))]
...
#[derive(Node, Serialize, Deserialize, Debug, Clone)]
#[serde(rename_all = "camelCase")]
#[sorm(table = alien_with_explicit_attributes)]
pub struct AlienWithExplicitAttributes {
    #[sorm(ty = "record<alien_with_explicit_attributes>")]
    id: sql::Thing,
    ...
    // Again, we dont have to provide the type attribute, it can auto detect
    // #[sorm(link_many = "SpaceShip", ty = "set<record<space_ship>>")]
