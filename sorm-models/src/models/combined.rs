...
// #[sorm-derive(Node, TypedBuilder, Serialize, Deserialize, Debug, Clone)]
...
pub struct Student {
    ...
    #[sorm(link_one = Book, skip_serializing)]
    course: LinkOne<Book>,
...
#[derive(sorm::Edge, TypedBuilder, Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
#[sorm(table = writes)]
