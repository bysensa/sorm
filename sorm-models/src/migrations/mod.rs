...
#[serde(rename_all = "camelCase")]
#[sorm(table = user_credentials, schemafull)]
...
#[derive(Node, TableResources, Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
#[sorm(table = new_stuff, schemafull)]
pub struct NewStuff {
    pub id: SurrealSimpleId<Self>,
    pub first_name: String,
    pub created_at: chrono::DateTime<Utc>,
...
#[derive(Node, TableResources, Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
#[sorm(table = planet, schemafull, relax_table)]
pub struct PlanetV2 {
    pub id: SurrealSimpleId<Self>,
    // #[sorm(old_name = "firstName")]
    pub new_name: String,
...
pub mod snake_cases {
    ...
    #[derive(Node, TableResources, Serialize, Deserialize, Debug, Clone, Default)]
    #[sorm(table = animal_snake_case, schemafull)]
    ...
    #[derive(Node, TableResources, Serialize, Deserialize, Debug, Clone, Default)]
    #[sorm(table = animal_snake_case, schemafull, relax_table)]
    pub struct AnimalSnakeCaseV2 {
        pub id: SurrealSimpleId<Self>,
        pub species: String,
        #[sorm(old_name = attributes)]
        pub characteristics: Vec<String>,
        pub velocity: u64,
    }

    #[derive(Edge, TableResources, Serialize, Deserialize, Debug, Clone, Default)]
    #[sorm(table = eats_snake_case, schemafull)]
...
#[derive(Node, Serialize, Deserialize, Debug, Clone, Default)]
#[serde(rename_all = "camelCase")]
#[sorm(table = animal, schemafull, relax_table)]
pub struct AnimalV2 {
    pub id: SurrealSimpleId<Self>,
    pub species: String,
    #[sorm(old_name = attributes)]
...
#[derive(Edge, TableResources, Serialize, Deserialize, Debug, Clone, Default)]
#[sorm(table = eats_v2, schemafull, relax_table)]
