...
async fn test_create_alien_with_id_not_specified_but_generated_by_the_database(
    ...
    let created_ship = create_v2(space_ship.clone()).get_one(db.clone()).await?;

    // Id is generated after creation
    assert_eq!(
        created_ship.clone().id.to_string(),
...
#[tokio::test]
async fn test_create_alien_with_id_specified() -> SurrealOrmResult<()> {
    let db = Surreal::new::<Mem>(()).await.unwrap();
    db.use_ns("test").use_db("test").await.unwrap();
    ...
    assert_eq!(space_ship.id.to_string(), "space_ship:oyelowo");
    let created_ship = create_v2(space_ship.clone()).get_one(db.clone()).await?;
    // Id is generated after creation
    assert_eq!(created_ship.clone().id.to_string(), "space_ship:oyelowo");
    assert_eq!(
        created_ship.clone().id.to_string(),
        space_ship.id.to_string()
    );
...
#[tokio::test]
async fn test_create_alien_with_id_specified_as_uuid() -> SurrealOrmResult<()> {
    let db = Surreal::new::<Mem>(()).await.unwrap();
    db.use_ns("test").use_db("test").await.unwrap();
...
#[tokio::test]
async fn test_creation_with_returning_selected_fields() -> SurrealOrmResult<()> {
    let db = Surreal::new::<Mem>(()).await.unwrap();
    db.use_ns("test").use_db("test").await.unwrap();
    ...
    let created_ship = create_v2(space_ship.clone())
...
#[tokio::test]
async fn test_create_alien_with_links() -> SurrealOrmResult<()> {
    let db = Surreal::new::<Mem>(()).await.unwrap();
    db.use_ns("test").use_db("test").await.unwrap();
    ...
    let created_weapon = create_v2(weapon1.clone()).get_one(db.clone()).await?;
    ...
    let created_weapon = create_v2(weapon2.clone()).return_one(db.clone()).await?;
    ...
    let created_spaceship1 = create_v2(space_ship.clone()).get_one(db.clone()).await?;
    let created_spaceship2 = create_v2(space_ship2.clone()).get_one(db.clone()).await?;
    let created_spaceship3 = create_v2(space_ship3.clone()).get_one(db.clone()).await?;
    ...
    let created_alien = create_v2(unsaved_alien.clone())
...
async fn test_create_fetch_record_links() -> SurrealOrmResult<()> {
    ...
    let created_spaceship1 = create_v2(space_ship.clone()).return_one(db.clone()).await?;
    ...
    let space_ship_names: Option<SpaceShipName> = create_v2(unsaved_alien.clone())
...
async fn test_access_array_record_links_with_some_null_links() -> SurrealOrmResult<()> {
    ...
    create_v2(weapon_1.clone()).return_one(db.clone()).await?;
    ...
    let selected_aliens: Option<Alien> = select(arr![All, Alien::schema().spaceShips(All).all()])
        .from(Alien::table())
        // More idiomatic alternative way of fetching/loading a foreign field.
...
async fn test_create_set_statement() -> SurrealOrmResult<()> {
    ...
    let space_ship1 = create_v2::<SpaceShip>(vec![
    ...
    let _space_ship2 = create_v2::<SpaceShip>(vec![
    ...
    let _space_ship3 = create_v2::<SpaceShip>(vec![
